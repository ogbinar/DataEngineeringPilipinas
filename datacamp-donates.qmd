...
- A15: You can check the status of your scholarship application using our [Scholarship Status Checker](https://sites.google.com/view/depdatacampstatus/home). Please enter the required details in the status checker to view the latest update on your application.
